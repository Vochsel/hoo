...
const api = {
  ...
  workspace: {
    ...
    listBoardDirectory: (boardId: string, relativePath?: string) => ipcRenderer.invoke('workspace:listBoardDirectory', boardId, relativePath),
    readBoardFilePreview: (boardId: string, relativePath: string) => ipcRenderer.invoke('workspace:readBoardFilePreview', boardId, relativePath),
